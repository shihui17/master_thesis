...
Use hka_profile_opt() to optimize robot energy consumption given a set of randomly generated trapezoidal trajectories using HKA with different trajectory time. The trajectory time is randomly generated
and directly loaded into tools.trapezoidal method as an argument.
