...
def heuristic_kalman(N, Nbest, D, alpha, sd, n, sample_num, traj_time):
    ...
    end_qdd = np.zeros(6)
    debug = 0
    joint = generate_traj_time(traj_time, 201) # generate trapezoidal trajectory with given trajectory time, discretized with 201-401 time steps, change config in traj.py
