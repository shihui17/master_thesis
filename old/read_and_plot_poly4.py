...
def read_and_plot(q_dir, qd_dir, qdd_dir, time_dir):
    result_q = np.loadtxt(q_dir)
    result_qd = np.loadtxt(qd_dir)
    result_qdd = np.loadtxt(qdd_dir)
    time_vec = np.loadtxt(time_dir)
...
read_and_plot("result_q_int.txt", "result_qd_int.txt", "result_qdd_int.txt", "time_vec_int.txt")